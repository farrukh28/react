...
class Contact extends Component {
    ...
    handleSubmit(event) {
        ...
        event.preventDefault(); // prevents browser from going to other page.
    };
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        const reg = /^\d+$/; // all the characters should be numbers.
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-12">
                            <h3 className="page-name">Contact Us</h3>
                            <hr />
                        </div>
                    </div>
                                ...
                                <FormGroup row>
                                    ...
                                    <Col md={10}>
                                        <Input type="text" id="firstname" name="firstname" placeholder="First Name"
                                            ...
                                            onBlur={this.handleBlur} valid={errors.firstname === ""} invalid={errors.firstname !== ""} />
                                ...
                                <FormGroup row>
                                    ...
                                    <Col md={10}>
                                        <Input type="text" id="lastname" name="lastname" placeholder="Last Name"
                                            ...
                                            onBlur={this.handleBlur} valid={errors.lastname === ""} invalid={errors.lastname !== ""} />
                                ...
                                <FormGroup row>
                                    ...
                                    <Col md={10}>
                                        <Input type="tel" id="telnum" name="telnum" placeholder="Tel. Number"
                                            value={this.state.telnum} onChange={this.handleInputChange} onBlur={this.handleBlur}
                                ...
                                <FormGroup row>
                                    ...
                                    <Col md={10}>
                                        <Input type="email" id="email" name="email" placeholder="Email"
                                            value={this.state.email} onChange={this.handleInputChange} onBlur={this.handleBlur}
