...
import { Navbar, NavbarBrand, Jumbotron, Nav, NavItem, Collapse, NavbarToggler, Button, Modal, ModalBody, ModalHeader, Form, FormGroup, Input, Label } from 'reactstrap';
...
class Header extends Component {
    ...
    handleLogin(event) {
        ...
        this.toggleModal(); // close the modal when form is submitted.
        ...
        return (
            ...
            <>
                <Navbar dark expand="md">
                    <div className="container">
                        ...
                        <Collapse isOpen={this.state.isNavOpen} navbar>
                            <Nav className="text-center text-md-right" navbar>
                                <NavItem>
                ...
                <Modal isOpen={this.state.isModalOpen} toggle={this.toggleModal}>
                    <ModalHeader className="font-weight-bolder" toggle={this.toggleModal}>Login</ModalHeader>
                    <ModalBody>
